...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/venom/Desktop/Semester_5/project/Mashita/movie-app/public/storage' => 'string',
            'flasher.scripts' => 'array',
            'flasher.styles' => 'array',
            'flasher.options' => 'array',
            'flasher.default' => 'string',
            'flasher.main_script' => 'string',
            'flasher.inject_assets' => 'boolean',
            'flasher.translate' => 'boolean',
            'flasher.excluded_paths' => 'array',
            'flasher.flash_bag.success' => 'array',
            'flasher.flash_bag.error' => 'array',
            'flasher.flash_bag.warning' => 'array',
            'flasher.flash_bag.info' => 'array',
            'flasher.plugins.flasher.scripts' => 'array',
            'flasher.plugins.flasher.styles' => 'array',
            'flasher.plugins.flasher.options' => 'array',
            'flasher.plugins.notyf.scripts' => 'array',
            'flasher.plugins.notyf.styles' => 'array',
            'flasher.plugins.notyf.options' => 'array',
            'flasher.plugins.sweetalert.scripts' => 'array',
            'flasher.plugins.sweetalert.styles' => 'array',
            'flasher.plugins.sweetalert.options' => 'array',
            'flasher.filter' => 'array',
            'flasher.presets.created.type' => 'string',
            'flasher.presets.created.message' => 'string',
            'flasher.presets.created.options' => 'array',
            'flasher.presets.updated.type' => 'string',
            'flasher.presets.updated.message' => 'string',
            'flasher.presets.updated.options' => 'array',
            'flasher.presets.saved.type' => 'string',
            'flasher.presets.saved.message' => 'string',
            'flasher.presets.saved.options' => 'array',
            'flasher.presets.deleted.type' => 'string',
            'flasher.presets.deleted.message' => 'string',
            'flasher.presets.deleted.options' => 'array',
            ...
            'omdb.api_key' => 'string',
            'omdb.base_url' => 'string',
            'omdb.base_img_url' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/venom/Desktop/Semester_5/project/Mashita/movie-app/public/storage','flasher.scripts','flasher.styles','flasher.options',
'flasher.default','flasher.main_script','flasher.inject_assets','flasher.translate','flasher.excluded_paths',
'flasher.flash_bag.success','flasher.flash_bag.error','flasher.flash_bag.warning','flasher.flash_bag.info','flasher.plugins.flasher.scripts',
'flasher.plugins.flasher.styles','flasher.plugins.flasher.options','flasher.plugins.notyf.scripts','flasher.plugins.notyf.styles','flasher.plugins.notyf.options',
'flasher.plugins.sweetalert.scripts','flasher.plugins.sweetalert.styles','flasher.plugins.sweetalert.options','flasher.filter','flasher.presets.created.type',
'flasher.presets.created.message','flasher.presets.created.options','flasher.presets.updated.type','flasher.presets.updated.message','flasher.presets.updated.options',
'flasher.presets.saved.type','flasher.presets.saved.message','flasher.presets.saved.options','flasher.presets.deleted.type','flasher.presets.deleted.message',
'flasher.presets.deleted.options','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'mail.markdown.paths','omdb.api_key','omdb.base_url','omdb.base_img_url','permission.models.permission',
...
'livewire.update','livewire.upload-file','livewire.preview-file','login','register','logout','dashboard',
'dashboard.account.list','dashboard.movies.list','dashboard.movies.add','dashboard.movies.detail','dashboard.cinemas.add',
'storage.local',);
        registerArgumentsSet('views', 
'components.button.index','components.button.modal','components.img','components.input.file','components.input.index',
'components.input.select','components.input.textarea','components.layouts.app','components.layouts.auth','components.layouts.dashboard',
'components.layouts.dashboard.header','components.layouts.dashboard.page-title','components.layouts.dashboard.sidenav','components.layouts.dashboard.sidenav-nav','components.layouts.dashboard.theme-setting',
'components.link','components.modal','components.movie.table-card','components.script','components.side-nav-item',
'components.side-nav-sub','components.side-nav-title','components.table.index','components.widget.count','livewire.movies.movies-list',
'livewire.user.user-add','livewire.user.user-list','pages.auth.login','pages.auth.register','pages.dashboard.account.account-list',
'pages.dashboard.cinemas.cinemas-add','pages.dashboard.index','pages.dashboard.movies.movie-add','pages.dashboard.movies.movie-detail','pages.dashboard.movies.movie-list',
'volt-livewire::auth.login','volt-livewire::auth.register','volt-livewire::dashboard.account.account-list','volt-livewire::dashboard.cinemas.cinemas-add','volt-livewire::dashboard.index',
'volt-livewire::dashboard.movies.movie-add','volt-livewire::dashboard.movies.movie-detail','volt-livewire::dashboard.movies.movie-list','volt-livewire::movies.movies-list','volt-livewire::user.user-add',
'volt-livewire::user.user-list','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'flasher::messages.success','flasher::messages.error','flasher::messages.warning','flasher::messages.info','flasher::messages.The resource was created',
'flasher::messages.The resource was updated','flasher::messages.The resource was saved','flasher::messages.The resource was deleted','flasher::messages.resource',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OMDB_API_KEY',);
